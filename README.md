...
### This is a fork meant to fix issues with the original plugin when used with mapbox_maps_flutter. and it may have some special use cases I'll document.
## Features
